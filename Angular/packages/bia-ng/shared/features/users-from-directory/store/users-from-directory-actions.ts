...
export namespace FeatureUsersFromDirectoryActions {
  ...
  export const loadAllSuccess = createAction(
    '[Feature Users From AD] Load all success',
    props<{ users: UserFromDirectory[] }>()
  );

  export const failure = createAction(
    '[Feature Users From AD] Failure',
    props<{ error: any }>()
  );

  export const addFromDirectory = createAction(
    '[Feature Users From AD] CreateUserFromDirectory',
    props<{ usersFromDirectory: UserFromDirectory[] }>()
  );
}
