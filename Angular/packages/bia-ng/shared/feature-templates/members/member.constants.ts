import { CrudConfig } from '../crud-items/model/crud-config';
import { Member, memberFieldsConfiguration } from './model/member';

// TODO after creation of CRUD Member : adapt the global configuration
export const memberCRUDConfiguration: CrudConfig<Member> =
  new CrudConfig<Member>({
