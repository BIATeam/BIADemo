...
export const INIT_MEMBER_STATE: MemberState = membersAdapter.getInitialState({
...
export const memberReducers = createReducer<MemberState>(
  INIT_MEMBER_STATE,
...
export const getMemberById = (id: number) => (state: MemberState) =>
  state.entities[id];
