...
export interface NotificationState extends EntityState<NotificationListItem> {
...
export const INIT_NOTIFICATION_STATE: NotificationState =
...
export const getNotificationById = (id: number) => (state: NotificationState) =>
  state.entities[id];
