...
export namespace DomainRoleOptionsStore {
  export interface RoleOptionsState {
    roleOptions: fromRoleOptions.RoleOptionState;
  }

  /** Provide reducers with AoT-compilation compliance */
  export function reducers(
    state: RoleOptionsState | undefined,
    action: Action
  ) {
  ...
  export const { selectAll: getAllRoleOptions } =
    fromRoleOptions.roleOptionsAdapter.getSelectors(
