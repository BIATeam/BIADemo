...
export type LdapDomainState = EntityState<LdapDomain>;

export const INIT_LDAPDOMAIN_STATE: LdapDomainState =
  ldapDomainsAdapter.getInitialState({
    // additional props default values here
  });

export const ldapDomainReducers = createReducer<LdapDomainState>(
  INIT_LDAPDOMAIN_STATE,
