...
export namespace DomainUserOptionsStore {
  export interface UserOptionsState {
    userOptions: fromUserOptions.UserOptionState;
  }

  /** Provide reducers with AoT-compilation compliance */
  export function reducers(
    state: UserOptionsState | undefined,
    action: Action
  ) {
  ...
  export const { selectAll: getAllUserOptions } =
    fromUserOptions.userOptionsAdapter.getSelectors(
