...
export type TeamOptionState = EntityState<OptionDto>;

export const INIT_TEAMOPTION_STATE: TeamOptionState =
  teamOptionsAdapter.getInitialState({
    // additional props default values here
  });

export const teamOptionReducers = createReducer<TeamOptionState>(
  INIT_TEAMOPTION_STATE,
...
export const getTeamOptionById = (id: number) => (state: TeamOptionState) =>
  state.entities[id];
