...
export namespace DomainTeamOptionsStore {
  export interface TeamOptionsState {
    teamOptions: fromTeamOptions.TeamOptionState;
  }

  /** Provide reducers with AoT-compilation compliance */
  export function reducers(
    state: TeamOptionsState | undefined,
    action: Action
  ) {
  ...
  export const getTeamsState =
    createFeatureSelector<TeamOptionsState>(storeKey);
  ...
  export const { selectAll: getAllTeamOptions } =
    fromTeamOptions.teamOptionsAdapter.getSelectors(
