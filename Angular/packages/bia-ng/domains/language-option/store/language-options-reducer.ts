...
export type OptionDtoState = EntityState<OptionDto>;

export const INIT_OPTIONDTO_STATE: OptionDtoState =
  languageOptionsAdapter.getInitialState({
    // additional props default values here
  });

export const languageOptionReducers = createReducer<OptionDtoState>(
  INIT_OPTIONDTO_STATE,
...
export const getLanguageOptionById = (id: number) => (state: OptionDtoState) =>
  state.entities[id];
