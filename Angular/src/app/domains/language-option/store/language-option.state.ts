...
export function reducers(state: LanguageOptionsState | undefined, action: Action) {
...
export const getLanguagesState = createFeatureSelector<LanguageOptionsState>('domain-language-options');
...
export const { selectAll: getAllLanguageOptions } = fromLanguageOptions.languageOptionsAdapter.getSelectors(
