...
{ 
    export const loadAll = createAction('[Domain Role Options] Load all', props<{ teamTypeId: number }>());

    export const loadAllSuccess = createAction('[Domain Role Options] Load all success', props<{ roles: OptionDto[] }>());
    /*
