$oldRealSelector = 'notification-type'
$oldRealSelectorPlural = 'notification-types'
$newRealSelector = read-host "new option name? (singular)"
$newRealSelectorPlural = read-host "new option name? (plural)"
