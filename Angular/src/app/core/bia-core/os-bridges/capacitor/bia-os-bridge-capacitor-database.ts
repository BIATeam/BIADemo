...
export class BiaOsBridgeCapacitorDatabase extends BiaOsBridgeDatabase {
    ...
    async init() {
        ...
        this.sqliteDb = await this.sqliteService.openDatabase("biaDemo", false, 'no-encryption', 1, false);
    }
