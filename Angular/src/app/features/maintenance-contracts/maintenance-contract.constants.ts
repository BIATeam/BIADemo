...
import { MaintenanceContract, maintenanceContractFieldsConfiguration } from './model/maintenance-contract';

// TODO after creation of CRUD MaintenanceContract : adapt the global configuration
export const maintenanceContractCRUDConfiguration: CrudConfig<MaintenanceContract> = new CrudConfig({
