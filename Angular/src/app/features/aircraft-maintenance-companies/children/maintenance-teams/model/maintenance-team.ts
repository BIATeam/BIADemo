...
export const maintenanceTeamFieldsConfiguration: BiaFieldsConfig = {
  columns: [
    ...
    ...[
      ...
      Object.assign(
        new BiaFieldConfig('firstOperation', 'maintenanceTeam.firstOperation'),
        {
          isRequired: true,
      ...
      Object.assign(
        new BiaFieldConfig('operationCount', 'maintenanceTeam.operationCount'),
        {
      ...
      Object.assign(
        new BiaFieldConfig('currentCountry', 'maintenanceTeam.currentCountry'),
        {
      ...
      Object.assign(
        new BiaFieldConfig('currentAirport', 'maintenanceTeam.currentAirport'),
        {
          isRequired: true,
          type: PropType.OneToMany,
          validators: [Validators.required],
