...
@Component({
  selector: 'bia-classic-header-tablet',
  templateUrl: './classic-header-tablet.component.html',
  styleUrls: ['./classic-header-tablet.component.scss']
})
export class ClassicHeaderTabletComponent implements OnInit, OnDestroy {
  @Input()
