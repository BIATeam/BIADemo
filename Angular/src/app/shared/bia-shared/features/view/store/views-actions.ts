...
export const assignViewToTeam = createAction(
  '[Views] Assign view to team',
  props<AssignViewToTeam>()
);

export const removeUserView = createAction(
  '[Views] Remove user view',
  props<{ id: number }>()
);

export const setDefaultUserView = createAction(
  '[Views] Set default user view',
  props<DefaultView>()
);
...
export const addUserViewSuccess = createAction(
  '[Views] Add user view success',
  props<View>()
);

export const removeTeamView = createAction(
  '[Views] Remove team view',
  props<{ id: number }>()
);
...
export const openViewDialog = createAction(
  '[Views] Open view dialog',
  props<{ tableStateKey: string }>()
);
