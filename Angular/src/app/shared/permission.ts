...
export enum Permission {
  ...
  Site_Member_Read = 'Site_Member_Read',
  ...
  AircraftMaintenanceCompany_Member_Save = 'AircraftMaintenanceCompany_Member_Save',
  ...
  MaintenanceTeam_Member_Save = 'MaintenanceTeam_Member_Save',
