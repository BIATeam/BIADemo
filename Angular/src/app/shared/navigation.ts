 ...
 */
export function getNavigation(): BiaNavigation[] {
  return [
    {
      labelKey: 'app.users',
...
/**
 * Navigation array - initialized after permissions are loaded from backend.
 * Use this constant in your application (routes, modules, etc.)
 */
