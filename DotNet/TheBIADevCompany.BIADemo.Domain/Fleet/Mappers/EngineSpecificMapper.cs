// BIADemo only
// <copyright file="EngineSpecificMapper.cs" company="TheBIADevCompany">
...
namespace TheBIADevCompany.BIADemo.Domain.Fleet.Mappers
{
    ...
    /// <summary>
    /// The mapper used for engine (specific use case).
    /// </summary>
    public class EngineSpecificMapper : BaseMapper<EngineDto, Engine, int>
    {
