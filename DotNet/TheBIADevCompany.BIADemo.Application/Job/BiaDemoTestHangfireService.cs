...
namespace TheBIADevCompany.BIADemo.Application.Job
{
    ...
    public class BiaDemoTestHangfireService : BaseJob, IBiaDemoTestHangfireService
    {
        ...
        {
            this.fileDownloaderService.PrepareBackgroundDownload<IBiaDemoTestHangfireService>(requestedByUserId, x => x.GenerateExampleFileAsync("GeneratedFileExample.txt"));
        }
