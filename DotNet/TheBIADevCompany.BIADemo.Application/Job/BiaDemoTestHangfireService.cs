...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        public async Task<FileDownloadDataDto> GenerateExampleFileAsync()
        {
            await Task.Delay(5000);
            ...
            return new FileDownloadDataDto() { FilePath = downloadFileExamplePath, FileContentType = "text/plain; charset=utf-8", FileName = "FileExample.txt" };
            ...
            return new FileDownloadDataDto() { FilePath = downloadHugeFileExamplePath, FileContentType = "application/zip", FileName = "HugeFileExample.zip" };
        }
    }
}