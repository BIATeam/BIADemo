...
namespace TheBIADevCompany.BIADemo.Presentation.Api.Controllers.Fleet
{
    ...
    public class FlightsController : BiaControllerBase
    {
...
#endif
        {
            ...
            this.EntityName = "flight";
            this.EntityNamePlural = "flights";
#endif
        ...
        public virtual async Task<IActionResult> GetFile([FromBody] PagingFilterFormatDto filters)
        {
            ...
            return this.File(buffer, BiaConstants.Csv.ContentType + $";charset={BiaConstants.Csv.CharsetEncoding}", $"Flights{BiaConstants.Csv.Extension}");
        }
