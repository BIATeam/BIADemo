// <copyright file="DomainLayerUsingApplicationLayerCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Application layer into Domain layer.
    /// </summary>
    internal sealed class DomainLayerUsingApplicationLayerCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA005";
