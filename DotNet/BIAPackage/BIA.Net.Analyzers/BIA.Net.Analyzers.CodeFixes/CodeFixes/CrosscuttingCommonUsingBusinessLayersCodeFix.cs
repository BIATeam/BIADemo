// <copyright file="CrosscuttingCommonUsingBusinessLayersCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of business layers into Crosscutting.Common.
    /// </summary>
    internal sealed class CrosscuttingCommonUsingBusinessLayersCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA011";

        /// <inheritdoc/>
        public string Title => "BIA.Net - remove forbidden business layer reference";
