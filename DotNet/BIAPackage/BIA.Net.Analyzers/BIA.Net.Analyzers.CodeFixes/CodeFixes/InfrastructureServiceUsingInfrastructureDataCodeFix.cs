// <copyright file="InfrastructureServiceUsingInfrastructureDataCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Infrastructure.Data into Infrastructure.Service.
    /// </summary>
    internal sealed class InfrastructureServiceUsingInfrastructureDataCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA010";

        /// <inheritdoc/>
        public string Title => "BIA.Net - remove forbidden Infrastructure.Data reference";
