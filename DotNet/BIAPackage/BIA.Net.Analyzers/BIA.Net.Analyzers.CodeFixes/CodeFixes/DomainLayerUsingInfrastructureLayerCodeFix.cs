// <copyright file="DomainLayerUsingInfrastructureLayerCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Infrastructure layer into Domain layer.
    /// </summary>
    internal sealed class DomainLayerUsingInfrastructureLayerCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA006";
