// <copyright file="DomainLayerUsingPresentationLayerCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Presentation layer into Domain layer.
    /// </summary>
    internal sealed class DomainLayerUsingPresentationLayerCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA007";
