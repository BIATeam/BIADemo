// <copyright file="InfrastructureLayerUsingPresentationLayerCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Presentation layer into Infrastructure layer.
    /// </summary>
    internal sealed class InfrastructureLayerUsingPresentationLayerCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA009";

        /// <inheritdoc/>
        public string Title => "BIA.Net - remove forbidden Presentation layer reference";
