// <copyright file="ApplicationLayerUsingPresentationLayerCodeFix.cs" company="BIA">
...
namespace BIA.Net.Analyzer.CodeFixes
{
    ...
    /// <summary>
    /// Code fix when detecting using of Presentation layer into Application layer.
    /// </summary>
    internal sealed class ApplicationLayerUsingPresentationLayerCodeFix : ICodeFix
    {
        /// <inheritdoc/>
        public string DiagnosticId => "BIA004";
