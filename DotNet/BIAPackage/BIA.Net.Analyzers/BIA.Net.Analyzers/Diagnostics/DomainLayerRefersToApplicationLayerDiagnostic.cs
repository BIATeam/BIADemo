// <copyright file="DomainLayerRefersToApplicationLayerDiagnostic.cs" company="BIA">
...
namespace BIA.Net.Analyzers.Diagnostics
{
    ...
    /// <summary>
    /// Diagnostic to detect using of Application layer into Domain layer.
    /// </summary>
    internal sealed class DomainLayerRefersToApplicationLayerDiagnostic : DiagnosticBase
    {
        ...
        /// <inheritdoc/>
        protected override string DiagnosticId => "BIA005";

        /// <inheritdoc/>
        protected override string Category => "Architecture";

        /// <inheritdoc/>
        protected override string Title => "Forbidden reference to Application layer in Domain layer";

        /// <inheritdoc/>
        protected override string MessageFormat => "Domain layer should not reference Application layer: '{0}'";

        /// <inheritdoc/>
        protected override string Description => "Ensures that the Domain layer does not reference the Application layer to maintain architectural boundaries.";
        ...
        public override void Register(AnalysisContext analysisContext)
        {
            analysisContext.RegisterCompilationStartAction(compilationContext =>
            {
                ...
                this.RegisterForbiddenNamespacesDiagnostics(compilationContext, this.domainLayerNamespaces, this.applicationLayerNamespaces, domainDtoLayerNamespaces);
            });
        }
    }
}
