// <copyright file="DomainLayerRefersToInfrastructureLayerDiagnostic.cs" company="BIA">
...
namespace BIA.Net.Analyzers.Diagnostics
{
    ...
    /// <summary>
    /// Diagnostic to detect using of Infrastructure layer into Domain layer.
    /// </summary>
    internal sealed class DomainLayerRefersToInfrastructureLayerDiagnostic : DiagnosticBase
    {
        ...
        /// <inheritdoc/>
        protected override string DiagnosticId => "BIA006";

        /// <inheritdoc/>
        protected override string Category => "Architecture";

        /// <inheritdoc/>
        protected override string Title => "Forbidden reference to Infrastructure layer in Domain layer";

        /// <inheritdoc/>
        protected override string MessageFormat => "Domain layer should not reference Infrastructure layer: '{0}'";

        /// <inheritdoc/>
        protected override string Description => "Ensures that the Domain layer does not reference the Infrastructure layer to maintain architectural boundaries.";
        ...
        public override void Register(AnalysisContext analysisContext)
        {
            analysisContext.RegisterCompilationStartAction(compilationContext =>
            {
                ...
                this.RegisterForbiddenNamespacesDiagnostics(compilationContext, this.domainLayerNamespaces, this.infrastructureLayerNamespaces, domainDtoLayerNamespaces);
            });
        }
    }
}
