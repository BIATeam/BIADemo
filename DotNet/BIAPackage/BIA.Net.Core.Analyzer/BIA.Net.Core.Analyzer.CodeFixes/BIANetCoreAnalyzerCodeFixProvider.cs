namespace BIA.Net.Core.Analyzer
{
    ...
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(BIANetCoreAnalyzerCodeFixProvider)), Shared]
    public class BIANetCoreAnalyzerCodeFixProvider : CodeFixProvider
    {
        private const string Title = "Remove forbidden Domain reference";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
            => ImmutableArray.Create(BIANetCoreAnalyzerAnalyzer.DiagnosticId);
