...
namespace BIA.Net.Core.Application.User
{
    ...
    public class BaseTeamAppService<TEnumTeamTypeId, TTeamMapper> : TeamCrudAppServiceBase<BaseDtoVersionedTeam, BaseEntityTeam, int, PagingFilterFormatDto<TeamAdvancedFilterDto>, TTeamMapper>, IBaseTeamAppService<TEnumTeamTypeId>
