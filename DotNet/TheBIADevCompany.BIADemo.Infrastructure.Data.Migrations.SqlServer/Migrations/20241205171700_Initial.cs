    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    AircraftMaintenanceCompanyId = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true),
                    Code = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsApproved = table.Column<bool>(type: "bit", nullable: true),
                    FirstOperation = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastOperation = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ApprovedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NextOperation = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MaxTravelDuration = table.Column<TimeSpan>(type: "time", nullable: true),
                    MaxOperationDuration = table.Column<TimeSpan>(type: "time", nullable: false),
                    OperationCount = table.Column<int>(type: "int", nullable: false),
                    IncidentCount = table.Column<int>(type: "int", nullable: true),
                    TotalOperationDuration = table.Column<double>(type: "float", nullable: false),
                    AverageOperationDuration = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Msn = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Manufacturer = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsMaintenance = table.Column<bool>(type: "bit", nullable: true),
                    FirstFlightDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastFlightDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    MotorsCount = table.Column<int>(type: "int", nullable: true),
                    TotalFlightHours = table.Column<double>(type: "float", nullable: false),
                    ...
                    PlaneTypeId = table.Column<int>(type: "int", nullable: true),
                    CurrentAirportId = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageFlightHours = table.Column<double>(type: "float", nullable: true),
                    ...
                    IsToBeMaintained = table.Column<bool>(type: "bit", nullable: false),
                    IsHybrid = table.Column<bool>(type: "bit", nullable: true),
                    PrincipalPartId = table.Column<int>(type: "int", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Pilot", "Pilot" },
                    { 3, "MaintenanceTeam_Admin", "MaintenanceTeam administrator" },
